...
public class GUI {
	...
	public static ItemStack z = new ItemStack(Material.WHITE_STAINED_GLASS_PANE, 1);
	public static ItemStack on = new ItemStack(Material.YELLOW_STAINED_GLASS_PANE, 1);
	public static ItemStack op = new ItemStack(Material.LIGHT_BLUE_STAINED_GLASS_PANE, 1);
	public static ItemStack fn = new ItemStack(Material.ORANGE_STAINED_GLASS_PANE, 1);
	public static ItemStack fp = new ItemStack(Material.CYAN_STAINED_GLASS_PANE, 1);
	public static ItemStack tn = new ItemStack(Material.YELLOW_STAINED_GLASS_PANE, 1);
	public static ItemStack tp = new ItemStack(Material.LIGHT_BLUE_STAINED_GLASS_PANE, 1);
	...
	static {
		...
		t = new ItemStack(Material.LIME_STAINED_GLASS_PANE, 1);
		tMeta = t.getItemMeta();
		tMeta.setDisplayName(ChatColor.GREEN + "True");
		t.setItemMeta(tMeta);
		f = new ItemStack(Material.RED_STAINED_GLASS_PANE, 1);
		tMeta = f.getItemMeta();
		tMeta.setDisplayName(ChatColor.RED + "False");
		f.setItemMeta(tMeta);
		b = new ItemStack(Material.BLACK_STAINED_GLASS_PANE, 1);
		tMeta = b.getItemMeta();
		...
		temp = new ItemStack(Material.WHITE_CONCRETE_POWDER);
		tMeta = temp.getItemMeta();
		...
		temp = new ItemStack(Material.DRAGON_EGG, 1);
		tMeta = temp.getItemMeta();
		...
		temp = new ItemStack(Material.ENCHANTING_TABLE, 1);
		tMeta = temp.getItemMeta();
		...
		temp = new ItemStack(Material.CAMPFIRE, 1);
		tMeta = temp.getItemMeta();
		...
		temp = new ItemStack(Material.IRON_SHOVEL, 1);
		tMeta = temp.getItemMeta();
		tMeta.setDisplayName("Snow_Shovel");
		temp.setItemMeta(tMeta);
		particleM.setItem(25, temp);
		temp = new ItemStack(Material.SNOWBALL, 1);
		tMeta = temp.getItemMeta();
		...
		temp = new ItemStack(Material.EGG, 1);
		tMeta = temp.getItemMeta();
		...
		temp = new ItemStack(Material.LAPIS_LAZULI, 1);
		tMeta = temp.getItemMeta();
		tMeta.setDisplayName("Water_Drop");
		temp.setItemMeta(tMeta);
		particleM.setItem(32, temp);
		temp = new ItemStack(Material.CYAN_DYE, 1);
		tMeta = temp.getItemMeta();
